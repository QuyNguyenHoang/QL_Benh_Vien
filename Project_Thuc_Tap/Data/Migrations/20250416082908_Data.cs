    ...
    public partial class Data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DutyScheduleId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DutyDays = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DutySchedule_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ShiftChangeReceivers",
                columns: table => new
                {
                    ShiftChangeReceiverId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftChangeReceivers", x => x.ShiftChangeReceiverId);
                    table.ForeignKey(
                        name: "FK_ShiftChangeReceivers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShiftChangeRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ShiftChangeDay = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Reason = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftChangeRequests", x => x.ShiftChangeRequestId);
                    table.ForeignKey(
                        name: "FK_ShiftChangeRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompensatoryLeaves_UserId",
                table: "CompensatoryLeaves",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftChangeReceivers_UserId",
                table: "ShiftChangeReceivers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftChangeRequests_UserId",
                table: "ShiftChangeRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeKeeping_Id",
                table: "TimeKeeping",
                column: "Id");
